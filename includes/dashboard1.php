...
<body>
  ...
  <div class="col-2 col">
   ...
   <div class="row-1">
    ...
    <h3 style="margin-left: 5%; font-family: serif; font-size:18px;">Files</h3>
 ...
 <div class="row-2">
   ...
   <div class="box" style="width:690px; height:100px; margin-top:10px; margin-left: 5%; border: 1px dashed #000;background: rgba(217, 217, 217, 0.15);">
...
echo ' <button style="font-family: serif; font-weight: 300; font-size: 20px; margin-left: 10px;float: right; margin-top:6px;margin-left: 255px; border: 1px solid black;border-radius: 10px; border: none;background: rgba(85, 172, 238, 0.33);position: initial; ">'.$totalreq.'</button>';
