...
<div class="container">
    ...
    <div class="admin-product-form-container">
        ...
        <form action="add_courseback.php" method="post" enctype="multipart/form-data">
            <h3>Add New Courses</h3>

            <input   placeholder="Course Id" name="c_id" class="box">
            <input type="text" placeholder="Course Name" name="c_name" class="box">
            <input type="file" placeholder="Picture" name="file" class="box">
