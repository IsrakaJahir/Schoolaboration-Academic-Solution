...
if (isset($_POST['upload_btn']) && isset($_FILES['uploaded_file'])) {
    ...
    $upload_directory = "Folders/"; // Replace with your desired directory path
    ...
    if (move_uploaded_file($file_tmp, $file_path)) {
        ...
        $stmt = $conn->prepare("INSERT INTO files(file_name, file_path,folder_id) VALUES (?, ?,?)");
        $stmt->bind_param("ssi", $file_name, $file_path,$folder_id);
        $stmt->execute();
